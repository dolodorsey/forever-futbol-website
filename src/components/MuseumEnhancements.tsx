...
export function MuseumEnhancements({ museumSlug, museumName, cities, accent = "#d5aa49", accent2 = "#f2d88a" }: Props) {
  ...
  return <section className="museum-enhance" style={{ "--me-accent": accent, "--me-accent2": accent2 } as React.CSSProperties}>
    ...
    <div className="conversion" id="visit">
      <div className="enhance-head light"><span>PLAN YOUR VISIT</span><h2>Come for the discovery.</h2><p>Choose the city and the type of experience you want. The complete annual collection is intentionally not published before the visit.</p></div>
